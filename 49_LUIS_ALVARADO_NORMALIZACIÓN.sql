...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 18:24:25
...
(1, 'Colonia Piedras bonitas'),
(2, 'Barrio Santa Lucia'),
(3, 'Colonia Casa Blanca');
...
(1, 'Bote de shampoo grande', '2021-05-03', 1),
(2, 'Acondicionador para caballero', '2021-05-02', 2);
...
(1, 'Factura a nombre de Santos Reyes', '2021-05-01', 1),
(2, 'Factura a nombre de Carlos Zavala', '2021-05-02', 2);
...
(1, 'Bote de Shampoo grande a nombre de Santos Reyes', '2021-05-01', 1),
(2, 'Bote de acondicionador grande a nombre de Carlos Zavala', '2021-05-02', 2);
...
--
ALTER TABLE `tbl_pedido`
  MODIFY `ID_PEDIDIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
